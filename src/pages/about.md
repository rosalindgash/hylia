...
**Databases & Database Tools:** Microsoft Access, MySQL, phpMyAdmin

**Applications:** Amazon Web Services (familiar), Adobe Creative Suite, Adobe Acrobat, WordPress CMS, Microsoft Office (Word, Excel, PowerPoint, OneDrive, OneNote, Outlook, Publisher), Google Drive, Visual Studio, Visual Studio Code, Google Analytics

**Other:** FTP, SFTP, SSH, VPN, RSS